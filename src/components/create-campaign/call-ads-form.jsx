...
export const CreateCampaignCallAdsForm = () => {
  const {
    formData,
    setFormData,
    validationErrors,
  ...
  const handleInputChange = (e) => {
    ...
    // NOTE: Only allow number from 0-9
    if (dataset.phoneNumber && !/^\d*$/.test(value)) return;
    ...
    <>
      <CreateCampaignCard>
        ...
        <CreateCampaignContent>
          ...
          />
          <LabelInputContainer>
            <Label htmlFor={'call-ads-phone-no'}>
              Call Ads Phone Number <span className='text-brand-600'>*</span>
            </Label>
            <Input
              id={'call-ads-phone-no'}
              name={'callAdsPhoneNumber'}
            ...
            {validationErrors.callAdsPhoneNumber && (
              <ErrorMessage
                message={validationErrors.callAdsPhoneNumber}
                className={'ml-2'}
              />
            )}
          </LabelInputContainer>
          <LabelInputContainer>
            <Label htmlFor={'path-1'}>
              Path 1 <span className='text-brand-600'>*</span>
            </Label>
            <Input
              id={'path-1'}
              name={'path1'}
              ...
              maxLength={15}
            />
            {validationErrors.path1 && (
              <ErrorMessage
                message={validationErrors.path1}
                className={'ml-2'}
              />
            )}
          </LabelInputContainer>
          <LabelInputContainer>
            <Label htmlFor={'path-2'}>
              Path 2 <span className='text-brand-600'>*</span>
            </Label>
            <Input
              id={'path-2'}
              name={'path2'}
              ...
              maxLength={15}
            />
            {validationErrors.path2 && (
              <ErrorMessage
                message={validationErrors.path2}
                className={'ml-2'}
              />
            )}
          </LabelInputContainer>
...
export const CreateCampaignCallAdsPreview = () => {
      ...
      <CreateCampaignCard>
        ...
        <CreateCampaignContent className={'p-6 flex flex-col gap-8'}>
          ...
          <InputPreview
            ...
            value={formData.callAdsPhoneNumber}
          />
          <InputPreview label={'Path 1'} value={formData.path1} />
          <InputPreview label={'Path 2'} value={formData.path2} />
