...
export const CreateCampaignDemandGenMultiAssetForm = () => {
  const {
    formData,
    setFormData,
    validationErrors,
        ...
        <CreateCampaignContent>
          ...
          <LabelInputContainer>
            ...
            {validationErrors.cta && (
              <ErrorMessage message={validationErrors.cta} className={'ml-2'} />
            )}
          </LabelInputContainer>
          <CreateCampaignFormDate />
          <CreateCampaignBudget
          ...
          <LabelInputContainer>
            ...
            {validationErrors.url && (
              <ErrorMessage message={validationErrors.url} className={'ml-2'} />
            )}
          </LabelInputContainer>
          <CreateCampaignLocations
...
export const CreateCampaignDemandGetMultiAssetPreview = () => {
      ...
      <CreateCampaignCard>
        ...
        <CreateCampaignContent className={'p-6 flex flex-col gap-8'}>
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-y-8 gap-x-6'>
            ...
            <InputPreview label='Business Name' value={formData.businessName} />
            <InputPreview label='CTA' value={formData.cta} />
          ...
          <InputPreview
            ...
            value={formData.ytVideoURL}
          />
          <InputPreview label={'URL'} value={formData.url} />
